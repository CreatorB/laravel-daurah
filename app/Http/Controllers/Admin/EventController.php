...
class EventController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'konfirmasi_buka' => 'nullable|date',
            'konfirmasi_tutup' => 'nullable|date|after_or_equal:konfirmasi_buka',
        ...
        try {
            $event = Event::create([
                ...
                'konfirmasi_buka' => $request->konfirmasi_buka,
                'konfirmasi_tutup' => $request->konfirmasi_tutup,
