                ...
                <div class="card-body">
                    <form action="{{ route('admin.users.update', $user->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="nohp" class="form-control @error('nohp') is-invalid @enderror" value="{{ old('nohp', $user->nohp) }}" placeholder="081234567890" required>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="alamat" class="form-control @error('alamat') is-invalid @enderror" rows="3" placeholder="Alamat (juga akan tersimpan sebagai domisili)">{{ old('alamat', $user->alamat) }}</textarea>
